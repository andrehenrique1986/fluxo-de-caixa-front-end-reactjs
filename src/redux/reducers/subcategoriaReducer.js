  ...
  switch(action.type) {
    ...
    case TypesSubcategoria.ATUALIZAR_SUBCATEGORIA_REDUCER:
      return {
        ...
        subcategorias: state.subcategorias.map(subcategoria =>
          subcategoria.idSubcategoria === action.payload.idSubcategoria
            ? action.payload
            : subcategoria
        ),
        subcategoriaPorId: state.subcategoriaPorId && state.subcategoriaPorId.idSubcategoria === action.payload.idSubcategoria
          ? action.payload
    ...
    case TypesSubcategoria.EXCLUIR_SUBCATEGORIA_REDUCER:
      return {
        ...
        subcategoriaPorId: state.subcategoriaPorId && state.subcategoriaPorId.idSubcategoria === action.payload
          ? null
          : state.subcategoriaPorId
      };
