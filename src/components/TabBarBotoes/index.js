...
const Container = styled.div.attrs({
    className: `bg-[#a1c082] w-1/12 h-screen flex flex-col items-center justify-center mt-1`
})``;

const ListaBotoes = styled.ul.attrs({
    className: `space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 w-full`
})``;
    ...
    return (
        <Container>
            <ListaBotoes>
                ...
                <ItemBotoes>
                    <BotaoPrincipal onClick={abrirModalCategoria}>Categorias</BotaoPrincipal>
                    <ModalCategoria aberto={modalNovaCategoria} fechado={fecharModalCategoria}/>
                </ItemBotoes>
                <ItemBotoes>
